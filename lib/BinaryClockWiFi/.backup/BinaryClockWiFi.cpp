...
namespace BinaryClockShield
   {
   int BinaryClockWifi::s_ap_creds_num;
   int BinaryClockWifi::s_retry_num;
   ...
   bool BinaryClockWifi::wifiSetAPinfo(String& ssid, String& psk)
      {
      bool result = false;
      if (!ssid.isEmpty())
         {
   ...
   void BinaryClockWifi::start_wps(void)
      {
   ...
   */
   ...
   String BinaryClockWifi::wpspin2string(uint8_t a[])
      {
      char wps_pin[9];
      for (int i = 0; i < 8; i++)
         {
   ...
   void BinaryClockWifi::wifi_event_handler(void* arg, esp_event_base_t event_base, int32_t event_id, void* event_data)
      {
      static int ap_idx = 1;
   ...
   void BinaryClockWifi::got_ip_event_handler(void* arg, esp_event_base_t event_base, int32_t event_id, void* event_data)
      {
      ip_event_got_ip_t* event = (ip_event_got_ip_t*)event_data;
      ESP_LOGI(TAG, "got ip: " IPSTR, IP2STR(&event->ip_info.ip));
      }

   void BinaryClockWifi::wps_main(void)
      {
   ...
   */
   }  // END namespace BinaryCockShield