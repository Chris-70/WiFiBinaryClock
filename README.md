...
### __Other Boards__   
### **No other board requires any hardware modification.**
...
The WiFiBinaryClock software, Copyright (c) 2025 [`Chris-70`][Chris-70] and [`Chris-80`][Chris-80], are licensed under the GNU General Public License v3.0 (GPL-v3.0).  
